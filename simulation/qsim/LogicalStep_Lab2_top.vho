...
-- Equation(s):
-- \INST7|Mux5~0_combout\ = (\sw[5]~input_o\ & ((\sw[4]~input_o\ & ((\sw[7]~input_o\))) # (!\sw[4]~input_o\ & (\sw[6]~input_o\)))) # (!\sw[5]~input_o\ & (\sw[6]~input_o\ & (\sw[4]~input_o\ $ (\sw[7]~input_o\))))
...
-- Equation(s):
-- \INST6|Mux5~0_combout\ = (\sw[1]~input_o\ & ((\sw[0]~input_o\ & ((\sw[3]~input_o\))) # (!\sw[0]~input_o\ & (\sw[2]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[2]~input_o\ & (\sw[0]~input_o\ $ (\sw[3]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|clk_proc:COUNT[5]~q\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \INST8|clk_proc:COUNT[6]~q\,
	datad => VCC,
...
-- Equation(s):
-- \INST7|Mux1~0_combout\ = (\sw[5]~input_o\ & (!\sw[7]~input_o\ & ((\sw[4]~input_o\) # (!\sw[6]~input_o\)))) # (!\sw[5]~input_o\ & ((\sw[6]~input_o\ & ((\sw[7]~input_o\))) # (!\sw[6]~input_o\ & (\sw[4]~input_o\ & !\sw[7]~input_o\))))
...
-- Equation(s):
-- \INST6|Mux1~0_combout\ = (\sw[1]~input_o\ & (!\sw[3]~input_o\ & ((\sw[0]~input_o\) # (!\sw[2]~input_o\)))) # (!\sw[1]~input_o\ & ((\sw[2]~input_o\ & ((\sw[3]~input_o\))) # (!\sw[2]~input_o\ & (\sw[0]~input_o\ & !\sw[3]~input_o\))))
...
-- Equation(s):
-- \INST7|Mux0~0_combout\ = (\sw[7]~input_o\) # ((\sw[5]~input_o\ & ((!\sw[6]~input_o\) # (!\sw[4]~input_o\))) # (!\sw[5]~input_o\ & ((\sw[6]~input_o\))))
...
-- Equation(s):
-- \INST6|Mux0~0_combout\ = (\sw[3]~input_o\) # ((\sw[1]~input_o\ & ((!\sw[2]~input_o\) # (!\sw[0]~input_o\))) # (!\sw[1]~input_o\ & ((\sw[2]~input_o\))))
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[4]~input_o\ $ (\sw[0]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[4]~input_o\) # (\sw[0]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[4]~input_o\ & 
-- \sw[0]~input_o\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[5]~input_o\ $ (\sw[1]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[5]~input_o\) # (\sw[1]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[5]~input_o\ & 
-- \sw[1]~input_o\))))
...
-- Equation(s):
-- \INST2|Mux1~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[6]~input_o\ $ (\sw[2]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[6]~input_o\ & 
-- \sw[2]~input_o\))))
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[7]~input_o\ $ (\sw[3]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[7]~input_o\) # (\sw[3]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[7]~input_o\ & 
-- \sw[3]~input_o\))))
...
-- Equation(s):
-- \INST7|Mux6~0_combout\ = (\sw[5]~input_o\ & (\sw[4]~input_o\ & (!\sw[6]~input_o\ & \sw[7]~input_o\))) # (!\sw[5]~input_o\ & (\sw[6]~input_o\ $ (((\sw[4]~input_o\ & !\sw[7]~input_o\)))))
...
-- Equation(s):
-- \INST6|Mux6~0_combout\ = (\sw[1]~input_o\ & (\sw[0]~input_o\ & (!\sw[2]~input_o\ & \sw[3]~input_o\))) # (!\sw[1]~input_o\ & (\sw[2]~input_o\ $ (((\sw[0]~input_o\ & !\sw[3]~input_o\)))))
...
-- Equation(s):
-- \INST7|Mux4~0_combout\ = (\sw[6]~input_o\ & (\sw[7]~input_o\ & ((\sw[5]~input_o\) # (!\sw[4]~input_o\)))) # (!\sw[6]~input_o\ & (!\sw[4]~input_o\ & (\sw[5]~input_o\ & !\sw[7]~input_o\)))
...
-- Equation(s):
-- \INST6|Mux4~0_combout\ = (\sw[2]~input_o\ & (\sw[3]~input_o\ & ((\sw[1]~input_o\) # (!\sw[0]~input_o\)))) # (!\sw[2]~input_o\ & (!\sw[0]~input_o\ & (\sw[1]~input_o\ & !\sw[3]~input_o\)))
...
-- Equation(s):
-- \INST7|Mux3~0_combout\ = (\sw[5]~input_o\ & ((\sw[4]~input_o\ & (\sw[6]~input_o\)) # (!\sw[4]~input_o\ & (!\sw[6]~input_o\ & \sw[7]~input_o\)))) # (!\sw[5]~input_o\ & (!\sw[7]~input_o\ & (\sw[4]~input_o\ $ (\sw[6]~input_o\))))
...
-- Equation(s):
-- \INST6|Mux3~0_combout\ = (\sw[1]~input_o\ & ((\sw[0]~input_o\ & (\sw[2]~input_o\)) # (!\sw[0]~input_o\ & (!\sw[2]~input_o\ & \sw[3]~input_o\)))) # (!\sw[1]~input_o\ & (!\sw[3]~input_o\ & (\sw[0]~input_o\ $ (\sw[2]~input_o\))))
...
-- Equation(s):
-- \INST7|Mux2~0_combout\ = (\sw[5]~input_o\ & (\sw[4]~input_o\ & ((!\sw[7]~input_o\)))) # (!\sw[5]~input_o\ & ((\sw[6]~input_o\ & ((!\sw[7]~input_o\))) # (!\sw[6]~input_o\ & (\sw[4]~input_o\))))
...
-- Equation(s):
-- \INST6|Mux2~0_combout\ = (\sw[1]~input_o\ & (\sw[0]~input_o\ & ((!\sw[3]~input_o\)))) # (!\sw[1]~input_o\ & ((\sw[2]~input_o\ & ((!\sw[3]~input_o\))) # (!\sw[2]~input_o\ & (\sw[0]~input_o\))))
