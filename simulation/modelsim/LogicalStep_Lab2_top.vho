...
SIGNAL \INST3|INST2|FULL_ADDER_CARRY~0_combout\ : std_logic;
SIGNAL \INST3|INST3|FULL_ADDER_CARRY~0_combout\ : std_logic;
SIGNAL \INST5|logic_out[0]~0_combout\ : std_logic;
SIGNAL \INST5|logic_out[0]~1_combout\ : std_logic;
SIGNAL \INST5|logic_out[3]~4_combout\ : std_logic;
SIGNAL \INST5|logic_out[1]~2_combout\ : std_logic;
SIGNAL \INST5|logic_out[2]~3_combout\ : std_logic;
SIGNAL \INST7|Mux5~0_combout\ : std_logic;
SIGNAL \INST3|INST2|FULL_ADDER_SUM~combout\ : std_logic;
SIGNAL \INST4|logic_out[1]~1_combout\ : std_logic;
SIGNAL \INST4|logic_out[2]~2_combout\ : std_logic;
SIGNAL \INST4|logic_out[3]~3_combout\ : std_logic;
SIGNAL \INST4|logic_out[0]~0_combout\ : std_logic;
...
\INST3|INST2|FULL_ADDER_CARRY~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST2|FULL_ADDER_CARRY~0_combout\ = (\sw[5]~input_o\ & ((\sw[1]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[5]~input_o\ & (\sw[0]~input_o\ & (\sw[1]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST3|INST2|FULL_ADDER_CARRY~0_combout\);

-- Location: LCCOMB_X11_Y17_N2
\INST3|INST3|FULL_ADDER_CARRY~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST3|FULL_ADDER_CARRY~0_combout\ = (\sw[2]~input_o\ & ((\sw[6]~input_o\) # (\INST3|INST2|FULL_ADDER_CARRY~0_combout\))) # (!\sw[2]~input_o\ & (\sw[6]~input_o\ & \INST3|INST2|FULL_ADDER_CARRY~0_combout\))
...
PORT MAP (
	datab => \sw[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \INST3|INST2|FULL_ADDER_CARRY~0_combout\,
	combout => \INST3|INST3|FULL_ADDER_CARRY~0_combout\);

-- Location: LCCOMB_X11_Y17_N0
\INST5|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_out[0]~0_combout\ = (\sw[3]~input_o\ & ((\sw[7]~input_o\) # (\INST3|INST3|FULL_ADDER_CARRY~0_combout\))) # (!\sw[3]~input_o\ & (\sw[7]~input_o\ & \INST3|INST3|FULL_ADDER_CARRY~0_combout\))
...
PORT MAP (
	datab => \sw[3]~input_o\,
	datac => \sw[7]~input_o\,
	datad => \INST3|INST3|FULL_ADDER_CARRY~0_combout\,
	combout => \INST5|logic_out[0]~0_combout\);

-- Location: LCCOMB_X11_Y17_N26
\INST5|logic_out[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_out[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST5|logic_out[0]~0_combout\)))
...
PORT MAP (
	...
	datab => \sw[4]~input_o\,
	datad => \INST5|logic_out[0]~0_combout\,
	combout => \INST5|logic_out[0]~1_combout\);

-- Location: LCCOMB_X11_Y17_N8
\INST5|logic_out[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_out[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	...
	combout => \INST5|logic_out[3]~4_combout\);

-- Location: LCCOMB_X11_Y17_N28
\INST5|logic_out[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_out[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
\INST5|logic_out[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_out[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST5|logic_out[2]~3_combout\);

-- Location: LCCOMB_X13_Y17_N22
\INST7|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|Mux5~0_combout\ = (\INST5|logic_out[3]~4_combout\ & ((\INST5|logic_out[0]~1_combout\ & (\INST5|logic_out[1]~2_combout\)) # (!\INST5|logic_out[0]~1_combout\ & ((\INST5|logic_out[2]~3_combout\))))) # (!\INST5|logic_out[3]~4_combout\ & 
-- (\INST5|logic_out[2]~3_combout\ & (\INST5|logic_out[0]~1_combout\ $ (\INST5|logic_out[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST5|logic_out[0]~1_combout\,
	datab => \INST5|logic_out[3]~4_combout\,
	datac => \INST5|logic_out[1]~2_combout\,
	datad => \INST5|logic_out[2]~3_combout\,
	combout => \INST7|Mux5~0_combout\);

-- Location: LCCOMB_X11_Y17_N12
\INST3|INST2|FULL_ADDER_SUM\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST2|FULL_ADDER_SUM~combout\ = \sw[5]~input_o\ $ (\sw[1]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST3|INST2|FULL_ADDER_SUM~combout\);

-- Location: LCCOMB_X11_Y17_N14
\INST4|logic_out[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_out[1]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[1]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST3|INST2|FULL_ADDER_SUM~combout\)))
...
PORT MAP (
	dataa => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	datad => \INST3|INST2|FULL_ADDER_SUM~combout\,
	combout => \INST4|logic_out[1]~1_combout\);

-- Location: LCCOMB_X11_Y17_N24
\INST4|logic_out[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_out[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[6]~input_o\ $ (\INST3|INST2|FULL_ADDER_CARRY~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \INST3|INST2|FULL_ADDER_CARRY~0_combout\,
	combout => \INST4|logic_out[2]~2_combout\);

-- Location: LCCOMB_X11_Y17_N22
\INST4|logic_out[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_out[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\INST3|INST3|FULL_ADDER_CARRY~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[7]~input_o\,
	datad => \INST3|INST3|FULL_ADDER_CARRY~0_combout\,
	combout => \INST4|logic_out[3]~3_combout\);

-- Location: LCCOMB_X11_Y17_N18
\INST4|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_out[0]~0_combout\ = \sw[0]~input_o\ $ (((!\pb_n[2]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[0]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \INST4|logic_out[0]~0_combout\);

-- Location: LCCOMB_X13_Y17_N12
\INST6|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|Mux5~0_combout\ = (\INST4|logic_out[1]~1_combout\ & ((\INST4|logic_out[0]~0_combout\ & ((\INST4|logic_out[3]~3_combout\))) # (!\INST4|logic_out[0]~0_combout\ & (\INST4|logic_out[2]~2_combout\)))) # (!\INST4|logic_out[1]~1_combout\ & 
-- (\INST4|logic_out[2]~2_combout\ & (\INST4|logic_out[3]~3_combout\ $ (\INST4|logic_out[0]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST4|logic_out[1]~1_combout\,
	datab => \INST4|logic_out[2]~2_combout\,
	datac => \INST4|logic_out[3]~3_combout\,
	datad => \INST4|logic_out[0]~0_combout\,
	combout => \INST6|Mux5~0_combout\);

-- Location: LCCOMB_X13_Y17_N14
\INST8|DOUT_TEMP[1]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST8|DOUT_TEMP[1]~0_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & (!\INST7|Mux5~0_combout\)) # (!\INST8|clk_proc:COUNT[10]~q\ & ((!\INST6|Mux5~0_combout\)))
...
-- Equation(s):
-- \INST6|Mux1~0_combout\ = (\INST4|logic_out[1]~1_combout\ & (!\INST4|logic_out[3]~3_combout\ & ((\INST4|logic_out[0]~0_combout\) # (!\INST4|logic_out[2]~2_combout\)))) # (!\INST4|logic_out[1]~1_combout\ & ((\INST4|logic_out[2]~2_combout\ & 
-- (\INST4|logic_out[3]~3_combout\)) # (!\INST4|logic_out[2]~2_combout\ & (!\INST4|logic_out[3]~3_combout\ & \INST4|logic_out[0]~0_combout\))))
...
-- Equation(s):
-- \INST7|Mux1~0_combout\ = (\INST5|logic_out[3]~4_combout\ & (((!\INST5|logic_out[1]~2_combout\ & \INST5|logic_out[2]~3_combout\)))) # (!\INST5|logic_out[3]~4_combout\ & ((\INST5|logic_out[0]~1_combout\ & ((\INST5|logic_out[1]~2_combout\) # 
-- (!\INST5|logic_out[2]~3_combout\))) # (!\INST5|logic_out[0]~1_combout\ & (\INST5|logic_out[1]~2_combout\ & !\INST5|logic_out[2]~3_combout\))))
...
-- Equation(s):
-- \INST8|DOUT_TEMP[5]~1_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & ((!\INST7|Mux1~0_combout\))) # (!\INST8|clk_proc:COUNT[10]~q\ & (!\INST6|Mux1~0_combout\))
...
-- Equation(s):
-- \INST7|Mux0~0_combout\ = (\INST5|logic_out[3]~4_combout\) # ((\INST5|logic_out[1]~2_combout\ & ((!\INST5|logic_out[2]~3_combout\) # (!\INST5|logic_out[0]~1_combout\))) # (!\INST5|logic_out[1]~2_combout\ & ((\INST5|logic_out[2]~3_combout\))))
...
-- Equation(s):
-- \INST6|Mux0~0_combout\ = (\INST4|logic_out[3]~3_combout\) # ((\INST4|logic_out[1]~1_combout\ & ((!\INST4|logic_out[0]~0_combout\) # (!\INST4|logic_out[2]~2_combout\))) # (!\INST4|logic_out[1]~1_combout\ & (\INST4|logic_out[2]~2_combout\)))
...
-- Equation(s):
-- \INST8|DOUT_TEMP[6]~2_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & (\INST7|Mux0~0_combout\)) # (!\INST8|clk_proc:COUNT[10]~q\ & ((\INST6|Mux0~0_combout\)))
...
-- Equation(s):
-- \INST7|Mux6~0_combout\ = (\INST5|logic_out[1]~2_combout\ & (\INST5|logic_out[0]~1_combout\ & (\INST5|logic_out[3]~4_combout\ & !\INST5|logic_out[2]~3_combout\))) # (!\INST5|logic_out[1]~2_combout\ & (\INST5|logic_out[2]~3_combout\ $ 
-- (((\INST5|logic_out[0]~1_combout\ & !\INST5|logic_out[3]~4_combout\)))))
...
-- Equation(s):
-- \INST6|Mux6~0_combout\ = (\INST4|logic_out[1]~1_combout\ & (!\INST4|logic_out[2]~2_combout\ & (\INST4|logic_out[3]~3_combout\ & \INST4|logic_out[0]~0_combout\))) # (!\INST4|logic_out[1]~1_combout\ & (\INST4|logic_out[2]~2_combout\ $ 
-- (((!\INST4|logic_out[3]~3_combout\ & \INST4|logic_out[0]~0_combout\)))))
...
-- Equation(s):
-- \INST8|DOUT[0]~0_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & (\INST7|Mux6~0_combout\)) # (!\INST8|clk_proc:COUNT[10]~q\ & ((\INST6|Mux6~0_combout\)))
...
-- Equation(s):
-- \INST6|Mux4~0_combout\ = (\INST4|logic_out[2]~2_combout\ & (\INST4|logic_out[3]~3_combout\ & ((\INST4|logic_out[1]~1_combout\) # (!\INST4|logic_out[0]~0_combout\)))) # (!\INST4|logic_out[2]~2_combout\ & (\INST4|logic_out[1]~1_combout\ & 
-- (!\INST4|logic_out[3]~3_combout\ & !\INST4|logic_out[0]~0_combout\)))
...
-- Equation(s):
-- \INST7|Mux4~0_combout\ = (\INST5|logic_out[3]~4_combout\ & (\INST5|logic_out[2]~3_combout\ & ((\INST5|logic_out[1]~2_combout\) # (!\INST5|logic_out[0]~1_combout\)))) # (!\INST5|logic_out[3]~4_combout\ & (!\INST5|logic_out[0]~1_combout\ & 
-- (\INST5|logic_out[1]~2_combout\ & !\INST5|logic_out[2]~3_combout\)))
...
-- Equation(s):
-- \INST8|DOUT[2]~2_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & ((\INST7|Mux4~0_combout\))) # (!\INST8|clk_proc:COUNT[10]~q\ & (\INST6|Mux4~0_combout\))
...
-- Equation(s):
-- \INST6|Mux3~0_combout\ = (\INST4|logic_out[1]~1_combout\ & ((\INST4|logic_out[2]~2_combout\ & ((\INST4|logic_out[0]~0_combout\))) # (!\INST4|logic_out[2]~2_combout\ & (\INST4|logic_out[3]~3_combout\ & !\INST4|logic_out[0]~0_combout\)))) # 
-- (!\INST4|logic_out[1]~1_combout\ & (!\INST4|logic_out[3]~3_combout\ & (\INST4|logic_out[2]~2_combout\ $ (\INST4|logic_out[0]~0_combout\))))
...
-- Equation(s):
-- \INST7|Mux3~0_combout\ = (\INST5|logic_out[1]~2_combout\ & ((\INST5|logic_out[0]~1_combout\ & ((\INST5|logic_out[2]~3_combout\))) # (!\INST5|logic_out[0]~1_combout\ & (\INST5|logic_out[3]~4_combout\ & !\INST5|logic_out[2]~3_combout\)))) # 
-- (!\INST5|logic_out[1]~2_combout\ & (!\INST5|logic_out[3]~4_combout\ & (\INST5|logic_out[0]~1_combout\ $ (\INST5|logic_out[2]~3_combout\))))
...
-- Equation(s):
-- \INST8|DOUT[3]~3_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & ((\INST7|Mux3~0_combout\))) # (!\INST8|clk_proc:COUNT[10]~q\ & (\INST6|Mux3~0_combout\))
...
-- Equation(s):
-- \INST6|Mux2~0_combout\ = (\INST4|logic_out[1]~1_combout\ & (((!\INST4|logic_out[3]~3_combout\ & \INST4|logic_out[0]~0_combout\)))) # (!\INST4|logic_out[1]~1_combout\ & ((\INST4|logic_out[2]~2_combout\ & (!\INST4|logic_out[3]~3_combout\)) # 
-- (!\INST4|logic_out[2]~2_combout\ & ((\INST4|logic_out[0]~0_combout\)))))
...
-- Equation(s):
-- \INST7|Mux2~0_combout\ = (\INST5|logic_out[1]~2_combout\ & (\INST5|logic_out[0]~1_combout\ & (!\INST5|logic_out[3]~4_combout\))) # (!\INST5|logic_out[1]~2_combout\ & ((\INST5|logic_out[2]~3_combout\ & ((!\INST5|logic_out[3]~4_combout\))) # 
-- (!\INST5|logic_out[2]~3_combout\ & (\INST5|logic_out[0]~1_combout\))))
...
-- Equation(s):
-- \INST8|DOUT[4]~4_combout\ = (\INST8|clk_proc:COUNT[10]~q\ & ((\INST7|Mux2~0_combout\))) # (!\INST8|clk_proc:COUNT[10]~q\ & (\INST6|Mux2~0_combout\))
